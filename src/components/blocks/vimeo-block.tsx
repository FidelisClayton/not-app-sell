import { VideoEmbedBlock } from "@/models";
...
export type VimeoBlockProps = {
  block: VideoEmbedBlock;
};

const urlSchema = z.string().url();
export const VimeoBlock = ({ block }: VimeoBlockProps) => {
  ...
  return (
    <BlockWrapper block={block}>
      ...
      >
        {block.url ? (
          <VideoPlayer url={block.url} provider="Vimeo" id={block._id} />
        ) : (
          <>
            <Text fontSize="sm" color="gray.500">
              Link do vídeo no Vimeo
            </Text>
